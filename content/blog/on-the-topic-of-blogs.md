---
title: On the Topic of Blogs
description: First blog post and it talks about blogs. Wow.
category: Opinion
created: 2026-04-22 13:00+05:00
slug: on-the-topic-of-blogs
---

# On the Topic of Blogs

Originally this blog was a developmental placeholder, so Lorem Ipsum all the way down. However, I found the title very interesting, as the title of this post is the same as the placeholder title of that dev blog post, and it got me thinking, why did I actually want to write a blog? There's the obvious answer of: "every website has one, therefore so must I" and while that was my initial thought, the more I pondered it, the more I realized that it wasn't the whole story.

Before my time, so around 1990-2010, blogs were all there was. The entire internet was fragmented and split across different sites and different blogs. This changed with the rise of platforms like YouTube, Instagram, etc. and most communities moved there, it was free, all in one spot, no need to have 500 accounts, just one would do. This was the phase out of blogs, most stopped or migrated around this time, some are still around and kicking, mainly developer blogs for different projects, as it's difficult to dump all that technical info in a video and developers don't wanna be on camera, since we're all introverts who fear sunlight.
...
I don't know how to end this post... so... o7 I guess?
